#!/usr/bin/env python
#
# Editied/customized by Nate McKervey
# Props go to Benjamin et al. 
#
...
if __name__ == '__main__':
	...
	elif arg in ['-st','--storage-type']:
	    storage_type = sys.argv.pop(0)
	elif arg in ['-fs','--file-size']:
	    file_size_kb = sys.argv.pop(0)
        else:
            dev = arg
